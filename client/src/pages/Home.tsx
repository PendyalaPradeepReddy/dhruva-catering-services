...
const brassBuffet = ASSETS.brassBuffet;

const services = [
  { icon: CalendarHeart, title: "Wedding & reception", label: "Wedding banquets", image: ASSETS.weddingTable, alt: "An Indian wedding table arranged with celebration food", copy: "Well-paced banquet service and menus designed around the occasion." },
  { icon: Sparkles, title: "Live counter moments", label: "Live service", image: ASSETS.liveCounter, alt: "Chefs preparing food at a live catering counter", copy: "Freshly made counter experiences that bring energy to the celebration." },
  { icon: UtensilsCrossed, title: "Family occasions", label: "Private celebrations", image: ASSETS.desserts, alt: "Traditional Indian sweets arranged for a private celebration", copy: "Intimate engagement, birthday, and house-event catering from 50 guests." },
  { icon: UsersRound, title: "Corporate gatherings", label: "Large-format service", image: ASSETS.menuSpread, alt: "A generous Indian food spread prepared for a catered gathering", copy: "Dependable meal service for teams, launches, conferences, and large groups." },
];
